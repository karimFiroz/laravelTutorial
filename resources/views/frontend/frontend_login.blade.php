...
<body class="bg-gradient-primary">
    ...
    <form class="user">
            ...
            <div class="form-group">
                ...
                <a href="{{route('frontend.dashboard')}}" class="btn btn-primary btn-user btn-block"> Login</a>

                                                <hr>

            <a href="{{route('frontend.dashboard')}}" class="btn btn-google btn-user btn-block">
                        <i class="fab fa-google fa-fw"></i> Login with Google</a>


                <a href="{{route('frontend.dashboard')}}" class="btn btn-facebook btn-user btn-block">
